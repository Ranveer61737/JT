...
BOT_TOKEN = config['8180425816:AAFwVtqPBWR7jtpw3jCYp3EQjJbKF2smbfg']
ADMIN_IDS = config['6128159169']

bot = telebot.TeleBot(8180425816:AAFwVtqPBWR7jtpw3jCYp3EQjJbKF2smbfg)
redeemed_keys = set()
